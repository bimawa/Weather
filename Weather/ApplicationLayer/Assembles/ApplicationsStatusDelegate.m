//
// Created by Maxim Bunkov on 10/04/2018.
...
@interface ApplicationsStatusDelegate ()

@property(nonatomic, strong) id <GeolocationServiceProtocol> geolocationService;
@end

@implementation ApplicationsStatusDelegate {
...
- (void)applicationWillResignActive:(UIApplication *)application {
  ...
  [self.geolocationService startLocationBackground];
}
